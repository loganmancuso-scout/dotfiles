...
Personal opencode agent with skills and workflows for knowledge base management, troubleshooting, documentation, and infrastructure operations.

---

## What This Is

This directory contains the configuration and skills for a personalized opencode coding agent that provides:
...
│   └── scribe/            ← KB executor + scratch workspace [NEW]
│
├── agents/                ← Agent configurations
│
└── commands/              ← Custom commands

~/Documents/Notes/projects/<project-name>/
...
**Added:** `scribe` skill (previously only available as @scribe subagent)
- Now available as `/skill:scribe` for direct loading
- Dual-mode design: documentation mode + scratch mode
...
**Enhanced:** Other skills (caveman, debug, docs, ops)
- Aligned with pi agent's latest standards
- Better documentation and examples
- Clearer integration patterns

**Documented:** Comprehensive skills reference
- Created/copied `SKILLS.md` (covers everything)
...
- `AGENTS.md` updated to reference skills instead of subagents
...
3. ✅ **Redundancy Eliminated** — Cleaner skill definitions
...
### opencode.json
Main configuration for opencode agent.
...
- **~/Documents/Notes/docs/knowledge-base-structure.md** — KB file schemas
- **~/Documents/Notes/templates/** — KB file templates
- **~/Documents/Notes/projects/*/context.md** — Per-project institutional memory

---

## No Breaking Changes

✅ Skills system is now aligned with pi agent
✅ Renamed one skill (`knowledge-base` → `schema`)
✅ Added scribe skill (available as `/skill:scribe`)
...
| Skills added | 1 (scribe) |
| Workflows documented | 5+ |
| Anti-patterns defined | 6 |
| Breaking changes | 0 |
| Files updated | 2 (AGENTS.md, skills) |
| Files created | 2 (README.md, SKILLS.md) |

---

## Last Updated

**2026-05-29** — Skills system aligned with pi agent. Taxonomy clarified, documentation expanded, naming improved, scribe skill added.

**Key changes:**
- Renamed knowledge-base → schema
- Added scribe skill (previously @scribe subagent only)
- Enhanced other skills to match pi standards
- Created comprehensive SKILLS.md reference
- Updated AGENTS.md to reference skills instead of subagents
...
2. ✅ Try new skill: `/skill:scribe` (record work directly)
3. ✅ Read SKILLS.md for complete reference
4. ✅ Follow decision tree to choose which skills to load
5. ✅ Use workflow examples to understand skill composition
