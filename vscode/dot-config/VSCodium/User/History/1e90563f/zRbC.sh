...
bindl = , switch:off:Lid Switch,exec,hyprctl keyword monitor "DP-3, disable"\
bindl = , switch:off:Lid Switch,exec,hyprctl keyword monitor "DP-4, disable"\
bindl = , switch:on:Lid Switch,exec,hyprctl keyword monitor "eDP-1, disable"\
bindl = , switch:on:Lid Switch,exec,hyprctl keyword monitor "DP-3, enable"\
bindl = , switch:on:Lid Switch,exec,hyprctl keyword monitor "DP-4, enable"' \
