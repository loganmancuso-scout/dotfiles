...
function install-packages() {
  ...
  sudo apt install -y vim git curl restic snap pipewire python3-full python3-pip unzip perl freerdp2-x11 libspa-0.2-bluetooth qemu-kvm libvirt-daemon-system
