...
function print_ascii_time() {
  ...
  # Print the elapsed time in ASCII art using figlet
  figlet "Elapsed Time: $time_str"
  echo -e "$message\n######################################################\n"
}
...
function main() {
  ...
  # Do The Work #
    ...
    install-packages #install my custom packages
    install-frontend #install hyprland frontend
  fi
  
  echo -e "Completed main"
}
